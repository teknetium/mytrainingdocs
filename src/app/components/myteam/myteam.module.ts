...
import { NzTagModule, NzConfig, NZ_CONFIG, NzToolTipModule, NzPopoverModule, NzTabsModule, NzIconModule, NzModalModule, NzInputModule, NzRadioModule, NzCheckboxModule, NzPopconfirmModule, NzButtonModule, NzCollapseModule, NzTableModule, NzAlertModule, NzAutocompleteModule, NzDrawerModule, NzTreeModule, NzBadgeModule, NzProgressModule, NzDropDownModule, NzInputNumberModule, NzCardModule, NzSwitchModule } from 'ng-zorro-antd';
