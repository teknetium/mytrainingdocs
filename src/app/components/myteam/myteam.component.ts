import { Component, OnInit, AfterViewInit, ChangeDetectionStrategy, Directive, HostListener, ChangeDetectorRef, ViewChild, ElementRef, Renderer2 } from '@angular/core';
